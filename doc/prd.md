...
- 2026-02-22 起允许在灰度环境提前启用 V1.1 文档链路（PDF/PPT），正式口径仍保留版本分层。
...
- 若提前落地 V1.1，必须通过 Feature Flag 控制并在发布说明显式披露风险。
...
| 版本 | 日期 | 变更说明 |
|---|---|---|
| v1.2 | 2026-02-22 | 新增“V1.1 能力灰度前置”规则，允许在 Feature Flag 下提前交付 PDF/PPT 链路 |
